...
import sb.rxjava.examples.eventdriven.Impl1.dataaccess.server.ConnectionSubscription;
...
public class TestDatabase {
    ...
    public static void init() throws SQLException {
        ...
        File databaseDirectory = new File("target/rxjava_m5");
        try {
        ...
        Connection c = null;
        try {
            DriverManager.getConnection("jdbc:derby:rxjava_m5;create=true");
            c = DriverManager.getConnection("jdbc:derby:rxjava_m5");
    ...
    public static Connection createConnection() {
        try {
            return DriverManager.getConnection("jdbc:derby:rxjava_m5");
        } catch (SQLException ex) {
            throw new RuntimeException(ex.getMessage(), ex);
        }
    }
